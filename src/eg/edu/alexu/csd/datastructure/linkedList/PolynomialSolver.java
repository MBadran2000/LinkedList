...
public class PolynomialSolver implements  IPolynomialSolver{
	 ...
	 */
	public int[][] setTerms(SLinkedList X) {
	...
	public String print(char poly) {
		SLinkedList p1 = new SLinkedList();
		switch(poly){
		case'A':
			p1 = A;
			break;
	...
	public int[][] add(char poly1, char poly2) {
		SLinkedList p1 = new SLinkedList();
		SLinkedList p2 = new SLinkedList();
		R.clear();
		switch(poly1){
		case'A':
			p1 = A;
	 ...
	 */
	public SLinkedList multiplyList(char poly,int arr[][]) {
		SLinkedList p = new SLinkedList();
